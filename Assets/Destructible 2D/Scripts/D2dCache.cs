...
namespace Destructible2D
{
	...
	{
		/// <summary>This class pools T arrays to avoid runtime gcalloc, because some Unity properties only accept arrays that need to change in size between assignments.</summary>
