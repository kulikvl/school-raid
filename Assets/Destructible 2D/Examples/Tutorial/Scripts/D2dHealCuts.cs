...
namespace Destructible2D
{
	...
	[CustomEditor(typeof(D2dHealCuts))]
	public class D2dHealCuts_Editor : D2dEditor<D2dHealCuts>
	{
		protected override void OnInspector()
		{
			DrawDefault("threshold", "The amount of pixel change required to paint.");
			BeginError(Any(t => t.Speed <= 0));
				DrawDefault("speed", "The speed of healing.\n1 = 1 second\n2 = 0.5 second");
			EndError();
		}
	}
}
